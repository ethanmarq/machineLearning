...
from datasets.cav import SegmentationDataset, Compose, Resize
...
class CavDataProvider(CityBaseDataProvider):
    ...
    def build_datasets(self) -> tuple[any, any, any]:
        ...
        root_dirs = '/scratch/marque6/CaSSed_Dataset_Final'
        ...
        transform = Compose([Resize((1024, 672))])
  
        
        train_dataset = SegmentationDataset(root_dirs, 'train', transforms=transform)
        test_dataset = SegmentationDataset(root_dirs, 'test', transforms=transform)
